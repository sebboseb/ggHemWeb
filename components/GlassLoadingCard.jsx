...
function GlassLoadingCard() {
    const n = 8;
    return (
        <div className='grid grid-cols-2 sm:gap-9 gap-3 gap-x-9 sm:grid-cols-4'>
            {[...Array(n)].map((e, i) => (
                <div key={i} className=" sm:w-56 h-80 w-40 bg-slate-100 flex flex-col items-center rounded-sm">
