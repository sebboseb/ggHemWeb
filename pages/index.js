    ...
    <>
      ...
      <div className=" w-full flex flex-col items-center">
        <div className=" sm:h-96 h-44 flex w-full items-center justify-center text-slate-900 relative overflow-hidden bg-fixed">
          ...
          <div className=" absolute h-[18rem] sm:h-[32rem] w-[18rem] sm:w-[32rem] xl:h-[48rem] xl:w-[48rem] bg-sky-300 rounded-full animate-blob mix-blend-multiply filter blur-3xl opacity-50 select-none"></div>
