    ...
    <>
      ...
      <div className=" w-full flex flex-col items-center">
        <div className=" sm:h-96 h-44 flex w-full items-center justify-center text-slate-900 relative overflow-hidden bg-fixed">
          ...
          <div className=" absolute top-0 left-10 h-[18rem] sm:h-[32rem] w-[18rem] sm:w-[32rem] xl:h-[48rem] xl:w-[48rem] bg-purple-300 animate-blob animation-delay-4000 rounded-full mix-blend-multiply filter blur-3xl opacity-50 select-none"></div>
          <div className=" absolute top-0 right-10 h-[18rem] sm:h-[32rem] w-[18rem] sm:w-[32rem] xl:h-[48rem] xl:w-[48rem] bg-pink-300 animate-blob animation-delay-2000 rounded-full mix-blend-multiply filter blur-3xl opacity-50 select-none"></div>
          <div className=" absolute h-[18rem] sm:h-[32rem] w-[18rem] sm:w-[32rem] xl:h-[48rem] xl:w-[48rem] sm:bg-sky-300 rounded-full animate-blob mix-blend-multiply filter blur-3xl opacity-50 select-none"></div>
